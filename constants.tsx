...
export const MOCK_EVENTS: Event[] = [
    ...
    { id: 'e8', communityId: 'comm4', communityName: 'Wellness Warriors', title: 'Yoga in the Park', description: 'Morning yoga session at Uhuru Park. All levels welcome!', date: '2024-10-12T07:30:00Z', time: '07:30', location: 'Uhuru Park, Nairobi', creator: MOCK_USERS[3], latitude: -1.2929, longitude: 36.8197 },
    { id: 'e9', communityId: 'comm1', communityName: 'Tech Innovators KE', title: 'Online Coding Challenge', description: 'Test your skills in our monthly coding competition.', date: '2024-10-20T14:00:00Z', time: '14:00', location: 'Online (Discord)', creator: MOCK_USERS[1] },
    { id: 'e10', communityId: 'comm5', communityName: 'Music Hub TZ', title: 'Local Music Jam Session', description: 'Bring your instruments and join us for a fun jam session.', date: '2024-11-05T19:00:00Z', time: '19:00', location: 'The Little Theatre Club, Dar', creator: MOCK_USERS[5], latitude: -6.8000, longitude: 39.2833 },
];
...
export const MOCK_COMMUNITIES: Community[] = [
    ...
    { id: 'comm4', name: 'Wellness Warriors', description: 'A community for fitness, nutrition, and mental well-being.', coverUrl: 'https://picsum.photos/seed/comm4/600/200', memberCount: 4321, isMember: false, members: MOCK_USERS.slice(3,7), posts: [], category: 'Health', privacy: 'public', admins: ['u3'], events: MOCK_EVENTS.filter(e => e.communityId === 'comm4') },
    { id: 'comm5', name: 'Music Hub TZ', description: 'Connecting musicians and music lovers in Tanzania.', coverUrl: 'https://picsum.photos/seed/comm5/600/200', memberCount: 6789, isMember: true, members: MOCK_USERS.slice(0,3), posts: [], category: 'Music', privacy: 'public', admins: ['u5'], events: MOCK_EVENTS.filter(e => e.communityId === 'comm5') },
];
